...
<template>
  <a-modal
    ...
    :title="isUpdate?'修改<?php echo $moduleTitle?>':'添加<?php echo $moduleTitle?>'"
  ...
  <?php foreach ($columnList as $val) { ?>
    ...
    <?php } else {?>
      ...
      <a-form-item label="<?php echo $val['columnComment']?>" name="<?php echo $val['columnName']?>">
        <a-radio-group
          v-model:value="form.<?php echo $val['columnName']?>">
  ...
  <?php foreach ($columnList as $val) { ?>
    <?php if (isset($val['columnValue'])) {?>
        ...
        <?php echo $val['columnName']?>: [
          {required: true, message: '请输入<?php echo $val['columnComment']?>', type: 'number', trigger: 'blur'}
        ],
        <?php } elseif ($val['dataType'] == 'bigint' || $val['dataType'] == 'int' || $val['dataType'] == 'smallint' || $val['dataType'] == 'tinyint') {?>
    ...
    <?php } else {?>
        ...
        <?php echo $val['columnName']?>: [
          {required: true, message: '请输入<?php echo $val['columnComment']?>', type: 'string', trigger: 'blur'}
        ],
        <?php } else {?>
