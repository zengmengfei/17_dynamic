...
{/foreach}
    ...
    * @Apidoc\Returned("data",type="array",ref="app\api\model\{$tables[0].model_name}\getList",withoutField="{foreach $tables[0].datas as $k=>$item}{if '{$item.list}'!='true'}{$item.field},{/if}{/foreach}")
    */
...
{/foreach}
    * @Apidoc\Returned(ref="app\api\model\{$tables[0].model_name}\getInfoById",withoutField="{foreach $tables[0].datas as $k=>$item}{if '{$item.detail}'!='true'}{$item.field},{/if}{/foreach}")
    */
    ...
    * @Apidoc\Method("POST")
    * @Apidoc\Param (ref="app\api\model\{$tables[0].model_name}\getInfoById",withoutField="{foreach $tables[0].datas as $k=>$item}{if '{$item.add}'!='true'}{$item.field},{/if}{/foreach}")
    * @Apidoc\Returned (ref="app\api\model\{$tables[0].model_name}\getInfoById")
    */
    ...
    * @Apidoc\Method("PUT")
    * @Apidoc\Param (ref="app\api\model\{$tables[0].model_name}\getInfoById",withoutField="{foreach $tables[0].datas as $k=>$item}{if '{$item.edit}'!='true'}{$item.field},{/if}{/foreach}")
    * @Apidoc\Returned (ref="app\api\model\{$tables[0].model_name}\getInfoById")
    */
...
{/foreach}
    ...
    * @Apidoc\Method("POST")
    * @Apidoc\Param (ref="app\api\model\{$tables[1].model_name}\getInfoById",withoutField="id")
    * @Apidoc\Returned (ref="app\api\model\{$tables[1].model_name}\getInfoById")
    */
    ...
    * @Apidoc\Returned(ref="pagingParam")
    * @Apidoc\Returned (ref="app\api\model\{$tables[1].model_name}\getInfoById",type="array")
    */
